define(['dart_sdk', 'packages/angular/angular.template', 'packages/displaying_data/app_component.template', 'packages/angular/src/platform/bootstrap', 'packages/displaying_data/app_component'], function(dart_sdk, angular, app_component, bootstrap, app_component$) {
  'use strict';
  ...
  dart.trackLibraries("web/main.ddc", {
    ...
    "main.dart": main
  }, '{"version":3,"sourceRoot":"","sources":["main.dart","main.template.dart"],"names":[],"mappings":";;;;;;;;;;QAcoC,eAAE;;;kBAAF,eAAE;MAAF,ACAhC,eDAkC,SCA1B;YAAG;;;;EDAqB,eAAE;ACEpC,kBDFkC,ACE9B,eDFgC,SCExB,GAAE;AACZ;;AAEF,IDLkC,eAAE,YCKzB;AAEX,IDPkC,ACO5B,eDP8B,cCOjB;AACnB,IAAM,gCAAa;AACnB,IAAM,sCAAa;EACrB;UDVoC,eAAE;;AAApC,4CAAe,eAAC,2CAAY,EAAE,IAAI,AAAG,eAAD,cAAc;EACpD;;EADoC,eAAE;;0BAAF,eAAE;;;;;qBAAF,eAAE","file":"main.ddc.js"}');
  // Exports:
  return {
